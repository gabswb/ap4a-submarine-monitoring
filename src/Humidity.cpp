...
Humidity::Humidity() : Sensor("humidity", "%", 5000), m_mean(50.0), m_standartDerivation(5) {}

Humidity::Humidity(int frequency_p) : Sensor("humidity", "%", frequency_p), m_mean(50.0), m_standartDerivation(5) {}

Humidity::Humidity(const Humidity &humidity_p) : Sensor(humidity_p.m_sensorType, humidity_p.m_unit, humidity_p.m_frequency), m_mean(humidity_p.m_mean), m_standartDerivation(humidity_p.m_standartDerivation) {}
