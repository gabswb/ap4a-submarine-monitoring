...
Scheduler::Scheduler(std::default_random_engine* pGenerator_p, int tempFrq_p, int humiFrq_p, int pressFrq_p, int lightFrq_p, bool consoleActivation_p, bool logActivation_p):
		m_pGenerator(pGenerator_p),
